 ...
 * @brief 配置模块实现
 */
#include "serverframework/config.h"

#include <sys/stat.h>
#include <sys/types.h>
#include <unistd.h>

#include "serverframework/env.h"
#include "serverframework/util.h"
...
static serverframework::Mutex s_mutex;

void Config::LoadFromConfDir(const std::string &path, bool force) {
  std::string absoulte_path =
      serverframework::EnvMgr::GetInstance()->GetAbsolutePath(path);
